    ...
    <>
      ...
      <nav className="bg-gray-900 text-white shadow-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-4 py-3">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* profile trigger  (ALWAYS visible when logged-in) */}
            {user ? (
              <div ref={profileRef} className="relative">
                ...
                >
                  ...
                  {/* hide name on very small screens to save width */}
                ...
                {/* Profile dropdown */}
                {profileOpen && (
                  <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-xl animate-[fadeIn_0.15s_ease-out]">
                    {/* blue top bar */}
                    ...
                    <div className="py-2 text-gray-800 text-sm">
                      ...
                      >
                        <svg
                          ...
                          viewBox="0 0 20 20"
                        >
                          <path d="M10 10a3 3 0 110-6 3 3 0 010 6z" />
                          <path
                            fillRule="evenodd"
                            d="M.458 15.041A8 8 0 1119.541 15.04a9.956 9.956 0 01-9.541 4.709 9.956 9.956 0 01-9.54-4.708z"
                            clipRule="evenodd"
                          />
                        </svg>
                        Profile
                      ...
                      {isAdmin && (
                        ...
                        >
                          <svg
                            ...
                            viewBox="0 0 20 20"
                          >
                            <path d="M6 2a1 1 0 00-1 1v2h2V3h2v2h2V3h2v2h2V3a1 1 0 00-1-1H6z" />
                            <path
                              fillRule="evenodd"
                              d="M4 7a2 2 0 012-2h8a2 2 0 012 2v9a2 2 0 01-2 2h-2l-2 2-2-2H6a2 2 0 01-2-2V7zm3 2a1 1 0 100 2h6a1 1 0 100-2H7zm0 4a1 1 0 100 2h5a1 1 0 100-2H7z"
                              clipRule="evenodd"
                            />
                          </svg>
                          Admin Panel
              ...
              /* Logged-out button (visible on all screens) */
              <button
        ...
        <div className="md:hidden bg-gray-900 text-white shadow-inner px-4 py-4 space-y-4">
          {links.map(({ to, label }) => (
            <Link
              ...
              className={`block ${
                isActive(to) ? "text-blue-400 font-semibold" : "hover:text-blue-400"
              }`}
            >
              {label}
            </Link>
      ...
      >
        {authModal.page === "login" ? (
          <Login
            setCurrentPage={(p) => setAuthModal({ open: true, page: p })}
            onSuccess={() => setAuthModal({ open: false, page: "login" })}
          />
        ) : (
          <SignUp
            setCurrentPage={(p) => setAuthModal({ open: true, page: p })}
